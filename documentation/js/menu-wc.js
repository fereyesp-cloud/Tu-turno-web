...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">tu-turno-web documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/JuegosEstrategia.html" data-type="entity-link" >JuegosEstrategia</a>
                            </li>
                            <li class="link">
                                <a href="components/JuegosFamiliares.html" data-type="entity-link" >JuegosFamiliares</a>
                            </li>
                            <li class="link">
                                <a href="components/JuegosFiesta.html" data-type="entity-link" >JuegosFiesta</a>
                            </li>
                            <li class="link">
                                <a href="components/JuegosRol.html" data-type="entity-link" >JuegosRol</a>
                            </li>
                            <li class="link">
